...
from pydantic import BaseModel, ConfigDict, Field  # s, model_validator
...
class ChatZhipuAI(BaseChatModel):
    ...
    # client:
    zhipuai_api_key: Optional[str] = Field(default=ZHIPU_API_KEY, alias="api_key")
    """Automatically inferred from env var `ZHIPUAI_API_KEY` if not provided."""
    zhipuai_api_base: Optional[str] = Field(default=ZHIPUAI_API_BASE, alias="api_base")
