...
def summarize(
    ...
    from hulua.agents.prompts import summarize_prompt_zh

    chain = LLMChain(llm=model, prompt=summarize_prompt_zh)
...
def summarize_with_sources(
    ...
    from hulua.agents.prompts import summarize_with_sources_prompt_zh

    chain = LLMChain(llm=model, prompt=summarize_with_sources_prompt_zh)
